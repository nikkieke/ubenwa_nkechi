...
import 'package:ubenwa_nkechi/features/records/view/widgets/calender_timeline/items.dart';
    ...
    return SizedBox(
      ...
      child: ScrollablePositionedList.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          final activeMonthName = DateFormat.MMMM(_locale).format(currentDate);
          return Padding(
            padding: const EdgeInsets.only(right: 12, left: 4),
            child: Row(
              mainAxisSize: MainAxisSize.min,
              ...
              children: <Widget>[
                ...
                MonthItem(
                  ...
                  name: _monthSelectedIndex == index? activeMonthName: monthName,
